_base_ = [
    '../_base_/models/pcam_r18.py', '../_base_/datasets/levir_cd.py',
...
evaluation = dict(interval=100, metric=['mFscore', 'mIoU'], pre_eval=True, save_best='Fscore.changed', greater_keys=['Fscore'])